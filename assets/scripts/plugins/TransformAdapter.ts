...
class ResizePreset {
	...
	@property({
		visible: function(this: ResizePreset) {
			return this.resizeMode !== ResizeMode.ResizeByHeight && this.resizeMode !== ResizeMode.OriginalSize;
		},
	...
	@property({
		visible: function(this: ResizePreset) {
			return this.resizeMode !== ResizeMode.ResizeByWidth && this.resizeMode !== ResizeMode.OriginalSize;
		},
		tooltip: `Use +, -, *, / operands to manipulate dimensions below\n
			px - pixels
			pw - parent width (percentage)
	...
	@property({
		visible: function(this: ResizePreset) {
			return this.positionType !== PositionType.OriginalPosition;
		},
		tooltip: `Use +, -, *, / operands to manipulate dimensions below\n
			px - pixels
